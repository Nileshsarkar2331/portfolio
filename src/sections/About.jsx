    ...
    <section className="c-space section-spacing" id="about">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="flex items-end grid-default-color grid-1">
          ...
          />
          <div className="z-10">
            <p className="headtext">Hi, I'm Nilesh Sarkar</p>
            <p className="subtext">
              I’m in my 3rd-year engineering . Passionate about competitive programming and problem-solving. 
              I also work on web development using the MERN stack and have a keen interest in data science..
            </p>
          </div>
        ...
        <div className="grid-default-color grid-2">
          ...
          >
            ...
            <Card
              ...
              image="assets/logos/python2.jpg"
              containerRef={grid2Container}
            />
          </div>
        </div>
